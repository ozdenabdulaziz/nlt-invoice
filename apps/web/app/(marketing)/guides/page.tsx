...
export default function GuidesPage() {
  return (
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-16 px-4 pb-24 pt-10 sm:px-6 lg:px-8">
      <section className="grid gap-8 overflow-hidden rounded-[2.5rem] border border-border/70 bg-gradient-to-br from-background via-card to-primary/[0.05] px-6 py-8 shadow-[0_40px_120px_-72px_rgba(15,23,42,0.7)] backdrop-blur md:px-10 md:py-12 lg:grid-cols-[1.15fr,0.85fr] lg:gap-10">
